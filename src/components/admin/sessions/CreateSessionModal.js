...
const CreateSessionModal = ({ isOpen, onClose }) => {
  ...
  const validateCurrentStep = () => {
    ...
    switch (currentStep) {
      case 1: // Client Information & Primary Contact
    ...
    <div className={`modal create-session-modal ${isOpen ? 'modal--open' : ''}`} onClick={onClose}>
      <div className="modal__dialog" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal__content">
          <form onSubmit={(e) => e.preventDefault()} className="create-session-form">
            {/* Step 1: Client Information & Primary Contact */}
            {currentStep === 1 && (
              <>
                      ...
                      <div className="form-row">
                        ...
                        <div className="form-group">
                          ...
                          <select
                            ...
                            className="form-input"
                          >
                            <option value="">{t('admin.sessions.selectLocation', 'Select location')}</option>
                            <option value="client_home">{t('admin.sessions.locations.home', 'Client Home')}</option>
                            <option value="video_call">{t('admin.sessions.locations.online', 'Online')}</option>
                            <option value="phone_call">{t('admin.sessions.locations.phone', 'Phone Call')}</option>
